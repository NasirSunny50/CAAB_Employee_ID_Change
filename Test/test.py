...
def find_and_enable_disabled_foreign_keys():
    try:
        ...
        # Query to find disabled foreign key constraints, excluding Common_Payment table
        query_disabled_keys = """
        SELECT 
        ...
        WHERE fk.is_disabled = 1
            AND OBJECT_NAME(fk.parent_object_id) <> 'Common_Payment';
        """
        ...
        if not disabled_keys:
            ...
            logging.info("Enabled all disabled foreign keys except for Common_Payment.")
